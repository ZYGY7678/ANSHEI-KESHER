...
public class MainActivity extends Activity {
    ...
    private void addNetivotPublicData() {
        ...
        addRow("נתיבות","מסעדות","המקום של דודו","ד"ר יוסף סמלו 42","08-9931139");
        ...
        addRow("נתיבות","מוסכים","מוסך תהילה בע"מ","מרכז תעשיה 602","08-9933616");
        ...
        addRow("נתיבות","מזגנים ומיזוג","עידן האנרגיה בע"מ","נתיבות","072-3142990");
